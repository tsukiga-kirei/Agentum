    ...
    private WorkflowDraftApi.WorkflowBrickTemplate clusterBrick(
        ...
        return new WorkflowDraftApi.WorkflowBrickTemplate(
            ...
            Map.ofEntries(
                ...
                Map.entry("clusterOutputVariable", "cluster_result"),
                Map.entry("mergeRule", "## 智能体集群结论\n\n### 子智能体 1\n{{agent_1_output}}\n\n### 子智能体 2\n{{agent_2_output}}"),
                Map.entry("intentSelectionMode", "multiple"),
                Map.entry("intentFallbackMode", "fail"),
                Map.entry("intentRoutes", List.of()),
                Map.entry("intentInputTemplate", ""),
