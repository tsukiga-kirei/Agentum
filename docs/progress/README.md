...
| 认证与租户上下文 API | 公开租户列表、登录、当前用户、刷新、登出和活跃角色上下文 | 已完成 Access/Refresh Token 轮换、服务端吊销、前端自动续签和过期退登 |
...
| 编号 | 任务 | 目标 |
| --- | --- | --- |
| 1 | 认证与会话 API | 已完成公开租户列表、登录、Access/Refresh Token 刷新轮换、登出吊销、当前用户和角色切换；后续补登录设备管理与全端下线 |
